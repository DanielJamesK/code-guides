...
listings = [
    {user_id: users[0].id, tutor_name: "Daniel K", tutor_email: "Danielseed@test.com", title: "Ruby Tutor", description: "I am an experineced tutor with more than 10 years experience", price: 25.00, programming_language_id: ruby.id}
]
